...
<div class="min-h-96 max-w-4xl mx-auto px-4 py-10">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        @if($editMode)
            <form method="POST" action="{{ route('profile.update') }}">
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <a href="{{ route('profile') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-400">
                        Cancel
                    </a>
                </div>
            </form>
        @else
            ...
            <div class="mt-8">
                <a href="{{ route('profile', ['edit' => 'true']) }}" class="inline-block bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-700">
