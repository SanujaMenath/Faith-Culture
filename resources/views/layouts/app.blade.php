...
<body class="min-h-screen flex flex-col bg-white text-gray-900" x-data="{ showSearch: false }"
    ...
    <div x-show="showSearch" x-cloak x-transition:enter="transition ease-out duration-200"
        ...
        <div class="bg-white w-full max-w-md p-6 rounded-xl shadow-xl relative">
            <!-- Close Button -->
            <button @click="showSearch = false" class="absolute top-1 right-2 text-gray-500 hover:text-black text-xl">
