<header class=" fixed top-0 left-0 right-0 w-full py-2 bg-white shadow-2xl z-50">
  ...
  <div class="mx-auto lg:mx-8 px-4">
    ...
    <div class="hidden md:flex items-center justify-between">
      ...
      <a href="/"
        class="text-lg [@media(min-width:820px)]:text-2xl font-bold text-gray-900 flex items-center gap-2 group relative">
      ...
      <div class="flex items-center gap-4">
        ...
        <!-- Search Icon Trigger -->
        <button @click="showSearch = true" class="px-2 py-2">
    ...
    <div class="md:hidden flex items-center justify-between">
      <!-- Hamburger Menu (Left) -->
      <button class="px-2 py-1 text-gray-700 hover:text-black focus:outline-none" id="mobile-menu-button"
        aria-label="Menu">
  ...
  <div id="mobile-menu" class="md:hidden hidden bg-white border-t mt-2">
    <nav class="py-2">
      <a href="/"
        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->is('/') ? 'bg-gray-100 font-semibold text-gray-900' : '' }}">Home</a>
      <a href="/shop"
        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->is('shop*') ? 'bg-gray-100 font-semibold text-gray-900' : '' }}">Shop</a>
      <a href="/view-orders"
        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->is('view-orders*') ? 'bg-gray-100 font-semibold text-gray-900' : '' }}">Orders</a>
      <a href="/about"
        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->is('about*') ? 'bg-gray-100 font-semibold text-gray-900' : '' }}">About
        Us</a>
    </nav>
  </div>
</header>
