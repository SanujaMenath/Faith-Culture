                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <label class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-white cursor-pointer flex items-center justify-center">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($inventories as $inventory)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $inventory->stock_quantity > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
