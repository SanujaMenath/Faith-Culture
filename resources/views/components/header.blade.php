<header class=" bg-white shadow-md py-4">
  <div class=" mx-auto px-3 flex flex-col md:flex-row items-center justify-center gap-4">
    <a href="/" class="text-2xl font-bold text-gray-900 absolute left-3  flex items-center gap-2 hover:border-b-2 border-gray-900 group">
    ...
    <nav class="flex flex-wrap justify-center md:justify-end gap-3">
      ...
      <div class="absolute right-3 flex items-center gap-4">
        <a href="" class="relative px-2.5 pt-2 ">
          <span class="absolute inset-0 bg-gray-700 scale-x-0 z-0"></span>
         <i class="fa-solid fa-magnifying-glass">
            <span class="relative z-10"></span>
          </i>
        </a>
        <a href="/cart" class="relative px-2.5 pt-2 ">
          <span class="absolute inset-0 bg-gray-700 scale-x-0 z-0"></span>
        ...
        class="flex items-center px-3 py-3 font-medium text-black bg-gray-100 border-2 border-transparent rounded-lg transition-all hover:bg-gray-200 focus:outline-none">
